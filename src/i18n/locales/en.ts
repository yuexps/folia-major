...
export default {
  "notifications": {
    ...
    "altLyricsOn": "Alternative lyric sources enabled",
    "altLyricsOff": "Alternative lyric sources disabled",
  ...
  "options": {
    ...
    "dioramaSettingsDesc": "Camera style follows the theme's animation intensity (player-panel chip / AI themes). These control camera speed, motion amount and the geometry's audio response.",
    "dioramaCameraSpeed": "Camera Speed",
    "dioramaMotionAmount": "Motion Amount",
    "dioramaAudioReactivity": "Geometry Audio Response",
    ...
    "dioramaShowParticles": "Foreground Particles",
